            ...
            <div class="text-center">
                ...
                <div class="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    ...
                    <div class="relative group flex flex-col">
                        ...
                        <div class="hidden md:block absolute left-1/2 -translate-x-1/2 top-full mt-2 px-3 py-2 bg-slate-800 text-slate-300 text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-10 border border-slate-700">
                            I've had my gmail since it was invite only back in 2005... #hipstervibes
                    ...
                    <!-- Reddit -->
                    <div class="relative group flex flex-col">
                        <a href="https://www.reddit.com/user/dblumenau" target="_blank" rel="noopener noreferrer" class="glass rounded-xl px-8 py-4 flex items-center justify-center gap-3 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/20 w-full">
                            <svg class="w-6 h-6 text-cyan-400" fill="currentColor" viewBox="0 0 24 24">
